...
- `check_markdown_links.py`（G1，零差异）— 出处 lingxi 2026-07-25 CI 基线 — 验证：298 PR。
...
- `verify_docs.sh` / `verify_repository.sh`（缺工具明确失败、解释器下限、shellcheck 锁版本、行尾空白、敏感 `.env` 与私钥扫描、`unittest`）— 出处 lingxi 2026-07-25 基线、[PR #12](https://github.com/Moshuiwang/lingxi/pull/12)、PR #48 半开守卫。
